...
#----------------MONSTRO-------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if monstro_x <= 0 or monstro_x >= largura - monstroLargura:
            monstro_velocidade *= -1
            monstro_y = random.randint(0, altura // 2 - monstroAltura)
...
def jogar():
    ...
    def falar_nome():
        ...
        with sr.Microphone() as source:
            messagebox.showinfo("Aviso", "Fale o seu nickname......")
            try:
    ...
    def ao_fechar_janela():
        messagebox.showwarning("Aviso", "Fale ou digite seu nome para continuar!")
